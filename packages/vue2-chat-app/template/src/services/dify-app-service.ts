import { DifyAppStore, type IDifyAppItem } from '@/core/repository'; // Updated import
// import { type IDifyAppItem } from '@/core/types'; // No longer needed as IDifyAppItem comes from repository

// Define APP_LIST_KEY directly in this file
const APP_LIST_KEY = 'dify-app-list';
